	                    	...
	                    	<table class="goods_table">
	                    		<thead>
	                    			<tr>
	                    				...
	                    				<td class="th_column_3">제작사 이름</td>
	                    		...
	                    		<tr>
	                    			...
	                    			<td>
		                    			<a class="move" href='<c:out value="${list.goodsId}"/>'>
											<c:out value="${list.goodsName}"></c:out>
										</a>
	                    			</td>
	                    			<td><c:out value="${list.makerName}"></c:out></td>
...
$(".move").on("click", function(e){
	...
	moveForm.append("<input type='hidden' name='goodsId' value='"+$(this).attr("href") + "'>");
