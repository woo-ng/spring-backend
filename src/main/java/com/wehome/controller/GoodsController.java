...
public class GoodsController {
	...
	public ResponseEntity<List<AttachImageVO>> getAttachList(int goodsId){
		
		logger.info("getAttachList.........." + goodsId);
		
		return new ResponseEntity<List<AttachImageVO>>(attachMapper.getAttachList(goodsId), HttpStatus.OK);
	...
	public String goodsDetailGET(@PathVariable("bookId")int goodsId, Model model) {
		...
		model.addAttribute("goodsInfo", goodsService.getGoodsInfo(goodsId));
