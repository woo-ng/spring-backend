...
import com.wehome.service.MemberService;
...
public class MemberController {
    ...
    public String mailCheckGET(String email) throws Exception{
        ...
        /* 이메일 보내기 */
        String setFrom = "bioy3698@naver.com";
        String toMail = email;
    ...
    @PostMapping(value="login.do", consumes="application/x-www-form-urlencoded")
